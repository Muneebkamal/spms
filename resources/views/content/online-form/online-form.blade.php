    ...
    <div class="col-lg-6">
      <div class="card bg-label-info h-100">
        <div class="card-body d-flex justify-content-between">
          ...
          <div class="w-100 app-academy-sm-40 d-flex justify-content-center justify-content-sm-end h-px-150 mb-3 mb-sm-0">
            <img class="img-fluid scaleX-n1-rtl" src="{{asset('assets/img/default-imgs/building-1.png')}}" alt="boy illustration" />
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="card bg-label-warning h-100">
        <div class="card-body d-flex justify-content-between">
          ...
          <div class="w-100 app-academy-sm-40 d-flex justify-content-center justify-content-sm-end h-px-150 mb-3 mb-sm-0">
            <img class="img-fluid scaleX-n1-rtl" src="{{asset('assets/img/default-imgs/building-2.png')}}" alt="girl illustration" />
          </div>
        </div>
      </div>
    </div>
